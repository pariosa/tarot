...
public class StoryElementSeeder {
        ...
        TarotStoryElements theEmpress = new TarotStoryElements(
                        ...
                        "The climax blends subtle emotional battles with graceful diplomacy, where Inara must decide between vulnerability and control",
                        "Spaceship Serenity, Social lounges, Botanical gardens, Outer space vistas",
                        "Third person limited, focusing on Inara's internal struggle and nuanced social navigation",
